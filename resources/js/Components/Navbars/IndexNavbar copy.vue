<template>
  ...
  >
    ...
    >
      ...
      >
        <a href="/" class="flex items-center font-semibold text-6xl text-blueGray-600">
          <img src="/img/scroll-behavior: smoothn.jpg" alt="Logo PrimePC" class="h-12 w-auto">
            PrimePC
        </a>
        <button
        ...
        <ul class="flex flex-col lg:flex-row list-none mr-auto">
          <li class="flex items-center">
            <a
              ...
              href="#componentes"
              @click.prevent="scrollToSection('componentes')"
            >
              <i
